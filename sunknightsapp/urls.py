...
router.register(r'leaderboard', users.ClanUserLeaderboardViewSet, 'leaderboard')
router.register(r'userpointssubmission', points_submissions.BasicUserPointSubmissionViewSet)
router.register(r'eventquestssubmission',points_submissions.BasicEventQuestsSubmissionViewSet)
