...
class ModelTestCase(TestCase):
    ...
    def setUpBasics(self):
        ...
        self.basic_guild1=SunKnightsGuild.objects.create(name='Aurora',discord_server=self.basic_discord_server,discord_id=3,is_clanguild=True)
        self.basic_guild2=SunKnightsGuild.objects.create(name='Panda Squad',discord_server=self.basic_discord_server,discord_id=4,is_clanguild=True)
        self.basic_guild3=SunKnightsGuild.objects.create(name='Test',discord_server=self.basic_discord_server,discord_id=5,is_clanguild=True)
